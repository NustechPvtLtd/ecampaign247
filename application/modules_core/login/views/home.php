...
<!--										<input class="form-control" id=
                        ...
                        <div class="login_form_container wp1 delay-1s">
                            <div class="col-md-6 social_btn_group">
                                ...
                                <div class="form-group">
                                    <a class=
                                    "btn btn-primary google_btn"><i class="fa fa-google-plus"></i>Google+
                                    Login</a>
                                </div>

                                <div class="form-group">
                                    <a class=
                                    "btn btn-primary twitter_btn"><i class="fa fa-twitter"></i>Twitter
                                    Login</a>
                                </div>
                            </div>
                            ...
                            <div class="login_form">
                                ...
                                <div class="col-md-6">
                                    <?php echo form_open('login/index');?>
                                        ...
                                        "btn btn-lg btn-success theame_btn"
                                        type="submit">Login</button>
                                    <?php echo form_close();?>
                                </div><span class="register_anchor"><a href="#"
