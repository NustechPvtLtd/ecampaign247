...
<head>
    ...
    <link href="<?php echo base_url('elements');?>/css/style-content.css" rel="stylesheet">	
    <link href="<?php echo base_url('elements');?>/css/custom-builder.css" rel="stylesheet">
	<link href="<?php echo base_url('elements');?>/css/style-pricing.css" rel="stylesheet">
	<link href="<?php echo base_url('elements');?>/css/zoom.css"  rel="stylesheet">
	<link href="<?php echo base_url('elements');?>/css/ecommerce.css"  rel="stylesheet">	
	<link href="<?php echo base_url('elements');?>/css/style-dividers.css" rel="stylesheet">
	<link href="<?php echo base_url('elements');?>/css/video.css" rel="stylesheet">
	<link href="<?php echo base_url('elements');?>/css/style-team.css" rel="stylesheet">
	<link href="<?php echo base_url('elements');?>/css/style-portfolios.css" rel="stylesheet">
	<link href="<?php echo base_url('elements');?>/css/style-headers.css" rel="stylesheet">
	...
	<!--<script src="<?php echo base_url('elements');?>/js/jquery-ui-1.10.3.custom.min.js"></script>-->
...
//	                    			include_once 'customer_menu.php';
		...
		<!-- additional js applied for the builder -->
		
		<script src="<?php echo base_url('elements');?>/js/application.js"></script>		
		<script src="<?php echo base_url('elements');?>/js/velocity.min.js"></script>
        <script src="<?php echo base_url('elements');?>/js/enhance.js"></script>		
		<script src="http://vjs.zencdn.net/4.1/video.js"></script>
		
		<!-- end additional js applied for the builder -->
